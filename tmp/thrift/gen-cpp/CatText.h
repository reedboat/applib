...
class CatTextIf {
 public:
  ...
  virtual int32_t CatNumber(const std::string& doc) = 0;
...
class CatTextProcessor : virtual public ::apache::thrift::TProcessor {
 protected:
  boost::shared_ptr<CatTextIf> iface_;
  virtual bool process_fn(::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext);
 private:
  std::map<std::string, void (CatTextProcessor::*)(int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*, void*)> processMap_;
